...
| Windows path | upstream `desktop/windows/*.ps1` (v0.2.21) wrapped by `windows/install.ps1` | mechanics verified in CI on the current MSIX package; **not yet verified on a Windows screen** | 2026-09-18 |
